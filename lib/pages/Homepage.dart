...
import 'package:gd_api_1129/client/BarangClient.dart';
import 'package:gd_api_1129/entity/Barang.dart';
import 'package:gd_api_1129/pages/EditBarang.dart';
...
class Homepage extends ConsumerWidget {
  ...
  ListTile scrollViewItem(Barang b, context, ref) => ListTile(
      ...
      trailing: IconButton(onPressed: () => onDelete(b.id, context, ref),
        ...
        data: (barangs) => SingleChildScrollView(
          child: Column(
            children: barangs
                ...
                .toList()),
        ), //muncul ketik data berhasil diambil
        error: (err, s) => 
